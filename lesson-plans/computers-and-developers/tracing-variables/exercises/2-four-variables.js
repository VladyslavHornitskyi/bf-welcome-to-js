...
/*declared the variable. Read varaible a. Read variable b. Asigned value of the variable a concataneted with space and variable b. The value is Pieter Rabbit*/ 
let c = a + ' ' + b;

/*declared the variable. Read variable b.  Asigned value hello concataneted with variable c. The value is hello Pieter Rabbit*/
let d = 'hello ' + c;
...
/*variable d is reasigned with new value. Read variable c. good bye concatanated with variable c. The value is good bye Pieter Rabbit*/ 
d = 'good bye ' + c;
